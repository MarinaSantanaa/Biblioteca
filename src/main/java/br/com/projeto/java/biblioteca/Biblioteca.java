...
public interface Biblioteca {
    ...
    void emprestar(Aluno pessoa, List livros, LocalDate dataEmprestimo, Calendario calendario);

    void emprestar(Professor pessoa, List livros, LocalDate dataEmprestimo, Calendario calendario);
