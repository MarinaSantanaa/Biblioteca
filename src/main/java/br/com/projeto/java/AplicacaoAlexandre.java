...
public class AplicacaoAlexandre {
    public static void main(String[] args) {
       ...
       Devolucao devolucao = new Devolucao ();
        devolucao.devolver(alunos.get(3),LocalDate.of(2021,10,10),calendario);
        exibirAlunos(alunos);

        devolucao.devolver(professores.get(3),LocalDate.of(2021,10,10),calendario);
